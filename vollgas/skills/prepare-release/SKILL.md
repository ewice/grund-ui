...
Run `vollgas:smallest-diff --base origin/main` to verify the release branch is clean. Flag any dead code, speculative additions, or diff noise that slipped through per-component reviews.
