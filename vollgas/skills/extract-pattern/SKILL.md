...
Read `vollgas/reviewers/lit-reviewer/SKILL.md`. Use its content as the Agent prompt. Dispatch as Agent call. Read and inject as context: new shared file content, all updated consumer file contents, `vollgas/refs/lit-patterns.md` content, `vollgas/refs/ssr-contract.md` content.
