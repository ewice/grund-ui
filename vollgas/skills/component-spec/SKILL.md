---
name: "component-spec"
description: "Use to author a complete component specification before building. Run with --from <design-spec-path> to parse a Vollgas design spec, or interactively without arguments. Outputs docs/specs/{name}.spec.md."
---
...
```
/component-spec
/component-spec --from docs/vollgas/specs/{date}-{name}-design.md
```
...
Read `docs/vocabulary.md` and `vollgas/refs/component-shapes.md`.
