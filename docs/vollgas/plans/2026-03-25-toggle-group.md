...
> **For agentic workers:** REQUIRED SUB-SKILL: Use vollgas:subagent-driven-development (recommended) or vollgas:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
