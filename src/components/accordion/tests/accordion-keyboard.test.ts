...
function getTriggerButtons(el: GrundAccordion): HTMLButtonElement[] {
  return Array.from(el.querySelectorAll('grund-accordion-trigger')).map((t) =>
    getByPart<HTMLButtonElement>(t, 'trigger'),
  );
}
    ...
    const el = await fixture<GrundAccordion>(html`
      <grund-accordion>
        ...
        <grund-accordion-item value="b" disabled>
          <grund-accordion-header
            ><grund-accordion-trigger>B</grund-accordion-trigger></grund-accordion-header
          >
          <grund-accordion-panel>B</grund-accordion-panel>
        </grund-accordion-item>
        <grund-accordion-item value="c">
          <grund-accordion-header
            ><grund-accordion-trigger>C</grund-accordion-trigger></grund-accordion-header
          >
