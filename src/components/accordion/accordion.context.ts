...
export const accordionRootContext = createContext<AccordionRootContext>('accordion-root');

export const accordionItemContext = createContext<AccordionItemContext>('accordion-item');
